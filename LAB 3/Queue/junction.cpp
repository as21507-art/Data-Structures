 ...
 * @description Traffic junction simulation using Queue in C++
 * @date 2022-10-01
 */
...
//===============================================
// Create 4 Queues representing to each Road of the junction
Queue<Car> road[4]={Queue<Car>(QUEUE_SIZE),Queue<Car>(QUEUE_SIZE),Queue<Car>(QUEUE_SIZE),Queue<Car>(QUEUE_SIZE)};		
//===============================================
int main()
{
